...
var HighchartsjQuery = (function () {
    function HighchartsjQuery() {
        this.data = [
            {
                name: 'USA',
    ...
    return HighchartsjQuery;
}());
HighchartsjQuery = __decorate([
    core_1.Component({
        selector: 'my-chart',
        template: "<div style=\"width:60%\" id=\"container\"></div>"
    })
], HighchartsjQuery);
exports.HighchartsjQuery = HighchartsjQuery;
//# sourceMappingURL=highchartsjQuery.component.js.map